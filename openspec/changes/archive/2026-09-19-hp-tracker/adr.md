...
`docs/adr/0003`. The remaining decisions are spec behavior or reversible code
choices, so they stay in the specs and design.

## In-Force ADRs Reviewed

- `docs/adr/0001-static-first-sveltekit-on-cloudflare-workers.md` — static-first,
  no backend this release. The state store honors it: state persists on-device via
  localStorage, with no server code.
- `docs/adr/0002-character-data-behind-a-provider-interface.md` — authored data
